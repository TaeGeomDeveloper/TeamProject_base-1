    ...
    <article>
        ...
        <div id="Main_Box" align="center" style="width: 90%; margin:auto;">
            ...
            <form name="updateForm" enctype="multipart/form-data">
                <div style="border: 10px solid #04AA6D; border-radius: 20px; margin-bottom: 20px; margin-top: 30px; padding: 30px">
                    <table>
                        <tr>
                            <th>제목</th>
                            <td><input type="text" name="cb_title" id="cb_title" style="width: 80%;"
                                       maxlength='50' value="${board.cb_title}"></td>
                        ...
                        <tr>
                            <th>첨부파일</th>
                            <td><input type="file" name="cb_attachedFile">${cb_originFileName}</td>
                        </tr>
                    </table>
