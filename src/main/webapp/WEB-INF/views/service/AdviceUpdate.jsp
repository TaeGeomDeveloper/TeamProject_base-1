...
<head>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#cb_content').val('${fn:replace(consultation.ecb_content,"\'","\'")}');
...
<section>
    <article>
        <div id="Main_Box" align="center" style="width: 90%; margin:auto;">
            ...
            <div style="border: 10px solid #f58e45; border-radius: 20px; width: 100%; margin-bottom: 20px; padding: 50px">
                <form name="updateForm" enctype="multipart/form-data">
                    <table>
                        <tr>
                            <th>제목</th>
                            <td><input class="form-control" type="text" name="ecb_title" id="ecb_title"
                                       style="width: 80%;"
                                       maxlength='50' value="${consultation.ecb_title}"></td>
                            <td><input type="hidden" name="ecb_seq" value="${consultation.ecb_seq}"></td>
                        </tr>
                        <tr>
                            <th>내용</th>
                            <td width="1000px"><textarea name="ecb_content" id="cb_content"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th>첨부파일</th>
                            <td><input class="form-control"  type="file" name="ecb_attachedFile">${ecb_originFileName}</td>
                        </tr>
                    </table>
